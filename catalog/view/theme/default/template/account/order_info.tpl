      ...
      <tr>
        ...
        <td class="left" style="width: 50%;"><?php if ($payment_method) { ?>
          ...
          <?php if($order_status_id == 1){ ?>
            <?php if($payment_code == 'paybras_boleto') {?>
              <br><a target='_blank' href='<?php echo $payment_urls; ?>'>Gerar boleto bancário</a>
            <?php } elseif($payment_code == 'paybras_tef') { ?>
              <br><a target='_blank' href='<?php echo $payment_urls; ?>'>Ir para internet banking</a>
            <?php } ?>
          <?php } ?>
        </td>

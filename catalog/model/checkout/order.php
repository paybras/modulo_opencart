...
class ModelCheckoutOrder extends Model {    
    ...
    public function confirm($order_id, $order_status_id, $comment = '', $notify = false, $payment_url = null) {
        ...
        if ($order_info && !$order_info['order_status_id']) {
            ...
            $this->db->query("UPDATE `" . DB_PREFIX . "order` SET order_status_id = '" . (int)$order_status_id . "', date_modified = NOW(), payment_url = '" .$payment_url. "' WHERE order_id = '" . (int)$order_id . "'");
    ...
    public function update($order_id, $order_status_id, $comment = '', $notify = false, $payment_url = null) {
        $order_info = $this->getOrder($order_id);

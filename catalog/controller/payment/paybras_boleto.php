...
class ControllerPaymentPaybrasBoleto extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paybras_boleto.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/paybras_boleto.tpl';
		} else {
			$this->template = 'default/template/payment/paybras_boleto.tpl';
		}	
